    ...
    <body>
        ...
        <div id="container">
            ...
            <a href=\"logout.php\"><button type=\"button\" >Log Out</button></a>
                ...
                <div id="titlebar"> <center><b>Events</b></center> </div>
...
<!--            End of nav div-->
            ...
            <div id="content">
                ...
                <ul style="list-style-type:none; overflow:auto;padding: 10px; margin:0;">
                    ...
                    <!-- <li class="members">
                        <div>
                           <img src="" alt="Imagine"> 
                            ...
                            <span>
                                jklgdfijabid luf gab<br>ajisdoaiusdhapduah
                            </span> 
                    ...
                    <?php
                        ...
                        $Events = mysqli_query($con,"select * from Events order by Date DESC, EventTime DESC");

                        while($row = mysqli_fetch_array($Events)){
                            printf("<li class=\"schedule\"><div><p>");

                            printf("<img src=\" ".$row['EventPictures']." \" >");
                            printf("<span style=\"font-size:x-large;text-align:center; display: block;\"><b><u>".$row['Name']."</u></b></span>");
                    ...
                    <!-- <li class="schedule">
                        <div>
                            <p>
                                <img src="" alt="Imagine">
                                <span style="text-align:center; display: block;"><b>Links</b></span>
                                
                                <span>jktitlelgdfijabid luf gab<br>ajisdoaiusdhapduah</span> 
                            </p>
